...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.lstquestions;
      ListView lstquestions = ViewBindings.findChildViewById(rootView, id);
      if (lstquestions == null) {
        break missingId;
      }

      return new FragmentSecondBinding((ConstraintLayout) rootView, buttonSecond, lstquestions);
    }
